...
export const createProject = (name, type) => (dispatch, getState) => new Promise((resolve, reject) => {
...
export const submissionList = projectId => (dispatch, getState) => new Promise((resolve, reject) => {
  dispatch(setLoadingStatus(true));
